...
public class MainActivitySubtractTest {
    ...
    @Test
    public void mainActivitySubtract() {
        try {
            Thread.sleep(5000);
        ...
        ViewInteraction reactEditText3 = onView(
                allOf(childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        reactEditText3.perform(replaceText("4"), closeSoftKeyboard());
        ...
        ViewInteraction reactEditText5 = onView(
                allOf(childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        reactEditText5.perform(replaceText("3"), closeSoftKeyboard());
